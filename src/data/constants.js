export const IMGS = {
  ...
  dcdb: 'https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=200&q=80',
  cable: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200&q=80',
  mc4: 'https://images.unsplash.com/photo-1545259741-2ea3ebf61fa3?w=200&q=80',
  earth: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200&q=80'
};

export const TECH = [
  { id:'hjt', name:'HJT Bifacial Solar Module', short:'HJT Technology', badge:'Premium', badgeType:'gold',
  ...
  { id:'ntype', name:'N-Type TOPCon Solar Module', short:'N-Type TOPCon', badge:'High Efficiency', badgeType:'red',
  ...
  { id:'perc', name:'Mono PERC Solar Module', short:'Mono PERC', badge:'Best Value', badgeType:'red',
...
export const PANELS = [
  { wp:560, name:'560 Wp Solar Panel', model:'SS-560M-HMB', cells:'144 Half-Cut Cells', voc:'48.2V', isc:'14.82A', img:IMGS.panel560, price:9800, mrp:12500 },
  { wp:590, name:'590 Wp Solar Panel', model:'SS-590M-HMB', cells:'144 Half-Cut Cells', voc:'49.8V', isc:'15.1A',  img:IMGS.panel590, price:10400, mrp:13200 },
  { wp:630, name:'630 Wp Solar Panel', model:'SS-630N-TOPCon', cells:'132 N-Type Cells', voc:'51.4V', isc:'15.8A', img:IMGS.panel630, price:11100, mrp:14000 },
  { wp:680, name:'680 Wp Solar Panel', model:'SS-680N-BiFacial', cells:'132 Bifacial Cells', voc:'53.6V', isc:'16.2A', img:IMGS.panel680, price:11900, mrp:15100 }
];

export const INVERTERS = [
  { kw:3, name:'3kW Single Phase On-Grid Inverter', model:'SS-INV-3K-SP', brand:'Samrat Solar',
  ...
  { kw:5, name:'5kW Single Phase On-Grid Inverter', model:'SS-INV-5K-SP', brand:'Samrat Solar',
